...
const MarkerCluster = (props) => {
    ...
    useEffect(() => {
      if (map && markers) {
        ...
        const clusterer = new MarkerClusterer(map, mapMarkers, {imagePath: 'https://raw.githubusercontent.com/googlemaps/js-marker-clusterer/gh-pages/images/m'})
        return () => {
...
class MapView extends Component{
    ...
    placeMarkers=()=>{
        ...
        const markers = data.filter(rows => rows.month==month).map((mydata, index) => {
        ...
        console.log("arrrayyy  = ", markers);
        return markers;
    }
    render(){
        console.log("in render ", this.placeMarkers())
        return(
            <>
            <div>
