...
function initMap () {
  ...
  document.getElementById('su').innerHTML =
    '<img src=' + iconbase + 'ylw-circle.png>   Supermarket'
  document.getElementById('st').innerHTML =
    '<img src=' + iconbase + 'grn-circle.png>   Stationary'
  document.getElementById('ph').innerHTML =
    '<img src=' + iconbase + 'pink-circle.png>   Pharmacy'
  document.getElementById('b').innerHTML =
    '<img src=' + iconbase + 'blu-circle.png>   Bakery'
